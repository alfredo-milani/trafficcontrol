...
public class SemaphoreSensorThread implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            greenLightStatus = (byte) ThreadLocalRandom.current().nextInt(0, 120 + 1);
            yellowLightStatus = (byte) ThreadLocalRandom.current().nextInt(0, 120 + 1);
            redLightStatus = (byte) ThreadLocalRandom.current().nextInt(0, 120 + 1);
            ...
            try {
                ...
                producer.send(new ProducerRecord<String, String>(topicName, jsonStringLamp));
