...
public class GlobalMedianCalculatorBolt extends AbstractWindowedBolt {



    private final Map<Long, MedianIntersection> medianIntersectionQueue;

    public GlobalMedianCalculatorBolt(int windowSizeInSeconds) {
        this(windowSizeInSeconds, DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
    }

    public GlobalMedianCalculatorBolt(int windowSizeInSeconds, int emitFrequencyInSeconds) {
